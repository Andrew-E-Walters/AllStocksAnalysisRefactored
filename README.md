...
When we ran the code we refactored the code ran for 0.2617188 seconds in the year 2017. It is clear that the code we created is faster than the previous one. 
## Summary
### Advantages
